  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-full p-6 sm:p-8">
      <div className="max-w-2xl text-center space-y-6">
        ...
        <Link
          to="/agent"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary text-primary-foreground font-semibold shadow-sm hover:shadow-md hover:opacity-90 active:opacity-100 transition focus:outline-none focus:ring-2 focus:ring-primary/30"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-16 max-w-5xl w-full">
        {FEATURES.map(({ icon: Icon, title, desc }) => (
          <div key={title} className="border rounded-lg p-5 space-y-2.5">
